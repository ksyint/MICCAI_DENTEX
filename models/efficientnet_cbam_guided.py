"""
EfficientNet models with CBAM and Guided Attention
...
class MBConvBlock(nn.Module):
    """
    Mobile Inverted Residual Bottleneck Block with CBAM and Guided Attention
    """
...
class EfficientNet_CBAM_Guided(nn.Module):
    """
    EfficientNet with CBAM and Guided Attention
    
    Args:
        width_coefficient: scaling coefficient for network width
